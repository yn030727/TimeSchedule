...
public class ChallengePunch {
    ...
    //当天挑战的名称
    int challenge_name_carrying;
    //当天挑战的介绍
    int challenge_introduce_carrying;

    public ChallengePunch(String challenge_day_carrying , int challenge_image_carrying , int challenge_name_carrying, int challenge_introduce_carrying ){
    ...
    public int getChallenge_introduce_carrying() {
        return challenge_introduce_carrying;
    }

    public int getChallenge_name_carrying() {
    ...
    public void setChallenge_introduce_carrying(int challenge_introduce_carrying) {
        this.challenge_introduce_carrying = challenge_introduce_carrying;
    }

    public void setChallenge_name_carrying(int challenge_name_carrying) {
        this.challenge_name_carrying = challenge_name_carrying;
    }
}
