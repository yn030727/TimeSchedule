...
public class SeventhFragmentAdapter extends RecyclerView.Adapter<SeventhFragmentViewHolder>{
    ...
    public SeventhFragmentAdapter(List<ChallengePunch> list , TextView progress){
        this.punchList = list;
    ...
    @NonNull
    @Override
    public SeventhFragmentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        database = challenge_Database.getInstance(parent.getContext());
        dao = database.getChallenge_data_dao();
        View view = View.inflate(parent.getContext(), R.layout.layout_fragment_seventh_carrying_recyclerview , null);
        SeventhFragmentViewHolder seventhFragmentViewHolder = new SeventhFragmentViewHolder(view);
        return seventhFragmentViewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull SeventhFragmentViewHolder holder, int position) {
        int layer = position;
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(layer == progress){
                    //完成当前挑战
                    dao.updateChallenge_data(new challenge_data(7,challenge,progress+1,complete));
                ...
                if(progress == 6){
                    ...
                    dao.updateChallenge_data(new challenge_data(7 ,0,0,1));
                }
            }
        });
    }
...
class SeventhFragmentViewHolder extends RecyclerView.ViewHolder{
    ...
    ImageView imageView;
    View card;
    public SeventhFragmentViewHolder(@NonNull View itemView) {
        super(itemView);
        day = itemView.findViewById(R.id.challenge_seventhFragment_carrying_textView);
        taskName = itemView.findViewById(R.id.challenge_seventhFragment_carrying_taskName);
        taskDescription = itemView.findViewById(R.id.challenge_seventhFragment_carrying_taskDescription);
        imageView = itemView.findViewById(R.id.challenge_seventhFragment_carrying_image);
        card = itemView.findViewById(R.id.challenge_seventhFragment_carrying_constraint);
    }
}