...
public class FifthFragmentAdapter extends RecyclerView.Adapter<FifthFragmentViewHolder>{
    ...
    public FifthFragmentAdapter(List<ChallengePunch> list , TextView progress){
        this.punchList = list;
    ...
    @NonNull
    @Override
    public FifthFragmentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        database = challenge_Database.getInstance(parent.getContext());
        dao = database.getChallenge_data_dao();
        View view = View.inflate(parent.getContext(), R.layout.layout_fragment_fifth_carrying_recyclerview , null);
        FifthFragmentViewHolder fifthFragmentViewHolder = new FifthFragmentViewHolder(view);
        return fifthFragmentViewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull FifthFragmentViewHolder holder, int position) {
        int layer = position;
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(layer == progress){
                    //完成当前挑战
                    dao.updateChallenge_data(new challenge_data(5,challenge,progress+1,complete));
                ...
                if(progress == 6){
                    ...
                    dao.updateChallenge_data(new challenge_data(5 ,0,0,1));
                }
            }
        });
    }
...
class FifthFragmentViewHolder extends RecyclerView.ViewHolder{
    ...
    ImageView imageView;
    View card;
    public FifthFragmentViewHolder(@NonNull View itemView) {
        super(itemView);
        day = itemView.findViewById(R.id.challenge_fifthFragment_carrying_textView);
        taskName = itemView.findViewById(R.id.challenge_fifthFragment_carrying_taskName);
        taskDescription = itemView.findViewById(R.id.challenge_fifthFragment_carrying_taskDescription);
        imageView = itemView.findViewById(R.id.challenge_fifthFragment_carrying_image);
        card = itemView.findViewById(R.id.challenge_fifthFragment_carrying_constraint);
    }
}