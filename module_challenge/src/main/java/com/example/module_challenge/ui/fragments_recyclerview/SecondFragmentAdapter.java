...
public class SecondFragmentAdapter extends RecyclerView.Adapter<SecondFragmentViewHolder>{
    ...
    public SecondFragmentAdapter(List<ChallengePunch> list , TextView progress){
        this.punchList = list;
    ...
    public SecondFragmentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = View.inflate(parent.getContext(), R.layout.layout_fragment_second_carrying_recyclerview , null);
        SecondFragmentViewHolder secondFragmentViewHolder = new SecondFragmentViewHolder(view);
        return secondFragmentViewHolder;
    }
    ...
    public void onBindViewHolder(@NonNull SecondFragmentViewHolder holder, int position) {
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(layer == progress){
                    //完成当前挑战
                    dao.updateChallenge_data(new challenge_data(2,challenge,progress+1,complete));
                ...
                if(progress == 6){
                    ...
                    dao.updateChallenge_data(new challenge_data(2 ,0,0,1));
                }
            }
        });
    }
...
class SecondFragmentViewHolder extends RecyclerView.ViewHolder{
    ...
    public SecondFragmentViewHolder(@NonNull View itemView) {
        super(itemView);
        day = itemView.findViewById(R.id.challenge_secondFragment_carrying_textView);
        taskName = itemView.findViewById(R.id.challenge_secondFragment_carrying_taskName);
        taskDescription = itemView.findViewById(R.id.challenge_secondFragment_carrying_taskDescription);
        imageView = itemView.findViewById(R.id.challenge_secondFragment_carrying_image);
        card = itemView.findViewById(R.id.challenge_secondFragment_carrying_constraint);
    }
}