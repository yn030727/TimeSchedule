...
public class SixthFragmentAdapter extends RecyclerView.Adapter<SixthFragmentViewHolder>{
    ...
    public SixthFragmentAdapter(List<ChallengePunch> list , TextView progress){
        this.punchList = list;
    ...
    @NonNull
    @Override
    public SixthFragmentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        database = challenge_Database.getInstance(parent.getContext());
        dao = database.getChallenge_data_dao();
        View view = View.inflate(parent.getContext(), R.layout.layout_fragment_sixth_carrying_recyclerview , null);
        SixthFragmentViewHolder sixthFragmentViewHolder = new SixthFragmentViewHolder(view);
        return sixthFragmentViewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull SixthFragmentViewHolder holder, int position) {
        int layer = position;
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(layer == progress){
                    //完成当前挑战
                    dao.updateChallenge_data(new challenge_data(6,challenge,progress+1,complete));
                ...
                if(progress == 6){
                    ...
                    dao.updateChallenge_data(new challenge_data(6 ,0,0,1));
                }
            }
        });
    }
...
class SixthFragmentViewHolder extends RecyclerView.ViewHolder{
    ...
    ImageView imageView;
    View card;
    public SixthFragmentViewHolder(@NonNull View itemView) {
        super(itemView);
        day = itemView.findViewById(R.id.challenge_sixthFragment_carrying_textView);
        taskName = itemView.findViewById(R.id.challenge_sixthFragment_carrying_taskName);
        taskDescription = itemView.findViewById(R.id.challenge_sixthFragment_carrying_taskDescription);
        imageView = itemView.findViewById(R.id.challenge_sixthFragment_carrying_image);
        card = itemView.findViewById(R.id.challenge_sixthFragment_carrying_constraint);
    }
}